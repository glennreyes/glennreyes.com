...
export function MenuLink({ children, ...props }: MenuLinkProps) {
  ...
  const classes = cn(
    ...
    'relative block min-h-11 px-4 py-3 transition focus-visible:ring-offset-2 focus-visible:transition-none md:min-h-0 rounded-full md:py-2 md:active:scale-95',
  );
