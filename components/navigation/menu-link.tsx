...
export const MenuLink = ({ children, ...props }: MenuLinkProps) => {
  ...
  const classes = clsx(
    ...
    'block py-3 text-sm font-medium transition focus-visible:ring-offset-2 focus-visible:transition-none md:rounded-full md:border md:px-4 md:active:scale-95',
  );
