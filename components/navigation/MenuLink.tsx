...
export function MenuLink({ children, ...props }: MenuLinkProps) {
  ...
  const classes = clsx(
    isActivePathname
      ? 'md:border-slate-300/25 dark:md:border-slate-500/25 text-teal-600 bg-white/10 dark:bg-slate-950/10 dark:text-teal-200/75 md:supports-[backdrop-filter]:backdrop-blur-md'
