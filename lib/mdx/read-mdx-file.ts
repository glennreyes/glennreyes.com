...
const classes = {
  autoLink: `before:absolute before:translate-x-[-0.85em] before:font-medium before:text-slate-400 before:opacity-0 before:transition before:content-['#'] md:before:hover:translate-x-[-1em] md:before:hover:opacity-100 md:before:focus-visible:translate-x-[-1em] md:before:focus-visible:opacity-100 md:before:focus-visible:transition-none`,
